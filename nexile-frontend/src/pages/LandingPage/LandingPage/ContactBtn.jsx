...
const ContactBtn =()=>{
    return(
        <div className="h-[520px] w-full lg:grid lg:grid-cols-2 md:grid-cols-2 gap-10 justify-center relative items-centers"
        style={{
          backgroundImage:
  ...
  ></div>
            ...
            <div className="mt-40">
              <p className="text-white text-center md:text-[24px] poppins-light">DO YOU</p>
              <h4 className="text-white text-[48px] poppins-semibold underline text-center">Want your imagination into reality?</h4>
