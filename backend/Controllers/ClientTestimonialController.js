...
export const addClientTestimonial = async (req, res) => {
    try {
        const { testimonialText, clientName, clientDescription, rating, socialLinks, websiteOrVideoLink } = req.body;
        ...
        const newTestimonial = new ClientTestimonialModel({
                testimonialText,
                clientName,
                clientImage: clientImageData && clientImageData.secure_url,
                publicId: clientImageData && clientImageData.public_id,
                clientDescription,
                rating,
                socialLinks,
                websiteOrVideoLink
